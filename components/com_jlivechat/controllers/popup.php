 ...
 */
	...
	if(empty($callback))
	{
	    echo json_encode(array('result' => $model->endChatSession($chatSessionId, null, $memberId)));
	}
	else
	{
	    echo $callback.'('.json_encode(array('result' => $model->endChatSession($chatSessionId, null, $memberId))).');';
	}
