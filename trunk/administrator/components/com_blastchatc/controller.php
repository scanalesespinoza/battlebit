<?php
/**
 * @version		$Id: controller.php 2011-07-21 15:24:18Z $
 ...
 */
class BlastChatCController extends JController
{
        /**
         * display task
         *
        ...
        function display($cachable = false) 
        {
                ...
                //JRequest::setVar('view', JRequest::getCmd('view', 'BlastChatC'));
                JRequest::setVar('view', JRequest::getCmd('view', 'admin'));
 
                // call parent behavior
                parent::display($cachable);
                
                BlastChatCHelper::addSubmenu(JRequest::getVar('view'));
        }
}