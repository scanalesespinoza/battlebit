 ...
 * @version $Id: checkjoopho.php 6505 2011-05-31 11:01:31Z trungnq $
...
class CheckJoomPhocaHelper
{
	...
	{
		$db = JFactory::getDBO();		
		$queryPhoca 	= "SELECT COUNT(*) FROM #__extensions WHERE STRCMP(`element`, 'com_phocagallery') = 0";
	...
	{
		$db 		 = JFactory::getDBO();		
		$queryJoomga = "SELECT COUNT(*) FROM #__extensions WHERE STRCMP(`element`, 'com_joomgallery') = 0";
