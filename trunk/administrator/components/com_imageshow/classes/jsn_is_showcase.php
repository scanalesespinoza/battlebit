 ...
 * @version $Id: jsn_is_showcase.php 6648 2011-06-08 10:13:51Z giangnd $
...
class JSNISShowcase
{
	...
	{
		$query 	= 'SELECT showcase_title, showcase_id  FROM #__imageshow_showcase ORDER BY date_modified DESC LIMIT '.(int)$limit;
		$this->_db->setQuery($query);
