 ...
 * @version $Id: showcaseinstalltheme.php 6505 2011-05-31 11:01:31Z trungnq $
...
<div id="jsnis-install-theme">
	<h3><?php echo JText::_('SHOWCASE_THEME_INSTALL_THEME'); ?></h3>
	<form id="jsn-form-install-theme" enctype="multipart/form-data" action="index.php?option=com_imageshow&controller=showcase&task=showcaseinstalltheme" method="post" name="adminForm">
		<p><strong><?php echo JText::_('SHOWCASE_THEME_SELECT_THEME'); ?> :</strong>&nbsp;<input class="input_box" id="install_package" name="install_package" type="file" size="57" /></p>
		<div class="jsnis-button-container"><button class="jsnis-button" onclick="submitbutton(); return false;"><?php echo JText::_('SHOWCASE_THEME_INSTALL_THEME'); ?></button></div>
