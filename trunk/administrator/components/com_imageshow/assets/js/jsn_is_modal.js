 ...
 * @version $Id: jsn_is_modal.js 6505 2011-05-31 11:01:31Z trungnq $
...
var JSNISModal = {
	...
	fromElement: function(el, options) {
		...
		this.assignOptions();
		this.url = (this.element ? (this.options.url || this.element.href) : el) || 'index.php?option=com_imageshow&controller=loading&tmpl=component';
		//this.url = 'index.php?option=com_imageshow&controller=loading&tmpl=component'	;
...
JSNISModal.extend(JSNISModal,Events.prototype);
JSNISModal.extend(JSNISModal,Options.prototype);
JSNISModal.extend(JSNISModal,Chain.prototype);