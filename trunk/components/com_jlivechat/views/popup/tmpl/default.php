...
<div id="livechat_container">
	...
	<h1>
		...
		<?php if(JRequest::getVar('popup_mode', null, 'method') == 'iframe') { ?><a href="javascript: void(0);" onclick="minimizeWnd();" id="minimize-window-button" class="minimize-wnd-icn">&nbsp;</a><?php } ?><a href="javascript: void(0);" onclick="closeWnd();" class="close-wnd-icn">&nbsp;</a>
	    </span>
	...
	<div id="jlc_toolbar_container" class="livechat_toolbar">
	    <span>
		<a href="javascript: void(0);" onclick="JLiveChat.toggleSoundNotifications();" id="mute_icon" title="Mute Sound" class="unmute_sound_icon">&nbsp;</a>
	    </span>
	</div>
