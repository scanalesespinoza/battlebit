 ...
 * @version $Id: default_core.php 6776 2011-06-16 02:26:17Z giangnd $
...
<div class="jsn-updater-wrapper">
	<div class="jsn-updater-content">
		...
		<iframe src="index.php?option=com_imageshow&controller=updater&layout=core&theme_id=<?php echo JRequest::getInt('element_id'); ?>&commercial=<?php echo JRequest::getVar('commercial'); ?>&format=clean" width="570" height="145" noresize="noresize" frameborder="0" border="0" cellspacing="0" scrolling="no" marginwidth="0" marginheight="0"></iframe>
		<hr />
