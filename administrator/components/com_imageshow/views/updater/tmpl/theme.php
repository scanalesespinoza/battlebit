 ...
 * @version $Id: theme.php 6776 2011-06-16 02:26:17Z giangnd $
 * @license GNU/GPL v2 http://www.gnu.org/licenses/gpl-2.0.html
 */
defined('_JEXEC') or die('Restricted access');
$themeID 	= JRequest::getInt('theme_id');
$commercial = JRequest::getVar('commercial');
$data 		= $this->objJSNUtil->getExtensionInfoByID($themeID);
?>
...
<div class="jsn-sub-updater-wrapper">
	<div class="jsn-sub-updater-content">
		...
		<input type="hidden" name="product_name" value="<?php echo strtolower($data->element);?>" />
