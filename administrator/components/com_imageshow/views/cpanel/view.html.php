...
class ImageShowViewCpanel extends JView
{
		function display($tpl = null)
		{
			...
			$lists['showlist'] 				= $objJSNShowlist->renderShowlistComboBox('0', JText::_('CPANEL_SELECT_SHOWLIST'), 'showlist_id', 'class="jsnis-gallery-selectbox" onchange="enableButton();"');
			$lists['showcase'] 				= $objJSNShowcase->renderShowcaseComboBox('0', JText::_('CPANEL_SELECT_SHOWCASE'), 'showcase_id', 'class="jsnis-gallery-selectbox" onchange="enableButton();"');
			$lists['menu'] 					= $objJSNUtils->renderMenuComboBox(null, 'Select menu' ,'menutype', 'class="jsnis-gallery-selectbox jsnis-menutype-selection" onchange="createViaMenu(false);"');
