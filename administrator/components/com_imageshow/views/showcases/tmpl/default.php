...
<table class="adminlist" border="0">
	<thead>
		<tr>
			...
			<th class="title" nowrap="nowrap" width="5%">
				<?php echo JHTML::_('grid.sort', JText::_('SHOWCASE_PUBLISHED'), 'sc.published', $this->lists['order_Dir'], $this->lists['order'] ); ?>
			</th>
			...
			<th width="10%" nowrap="nowrap">
				<?php echo JHTML::_('grid.sort', JText::_('SHOWCASE_THEME'), 'theme_name', $this->lists['order_Dir'], $this->lists['order'] ); ?>
			</th>
	...
	for ($i=0, $n=count( $this->items ); $i < $n; $i++)
	{
		...
		<tr class="<?php echo "row$k"; ?>">
			...
			<td>
				<span class="editlinktip hasTip" title="<?php echo JText::_('SHOWCASE_EDIT_SHOWCASE');?>::<?php echo $this->escape($row->showcase_title); ?>">
            ...
            <td align="center">
				<?php
					$part = explode('theme', $row->theme_name);
					if (isset($part[1]))
					{
