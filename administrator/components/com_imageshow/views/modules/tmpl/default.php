...
?>
<form action="<?php echo JRoute::_('index.php?option=com_imageshow&controller=modules&tmpl=component'); ?>" method="post" name="adminForm" id="adminForm">
	...
	<table class="adminlist" id="modules-mgr">
		...
		?>
			<tr class="row<?php echo $i % 2; ?>">
				...
				<td>
					<a class="poiter" onclick="if (window.parent) window.parent.selectModule_id('<?php echo $item->id?>', '<?php echo $this->escape($item->title); ?>', <?php echo JRequest::getCmd('seo'); ?>);">
