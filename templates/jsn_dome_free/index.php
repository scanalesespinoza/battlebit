...
<body id="jsn-master" class="jsn-textstyle-<?php echo $template_textstyle; ?> jsn-textsize-<?php echo $template_textsize; ?> jsn-color-<?php echo $template_color; ?> jsn-direction-<?php echo $template_direction; ?><?php echo ($pageclass != '')?' '.$pageclass:''; ?><?php echo ($is_ie6)?' jsn-ie6':''; ?><?php echo ($is_ie7)?' jsn-ie7':''; ?>">
	<div id="jsn-page">
	<?php
	...
	?>
		...
		?>
			...
			?>
                    <div id="jsn-pos-promo-left"><div id="jsn-pos-promo-left_inner">
						<jdoc:include type="modules" name="promo-left" style="jsnmodule" class="jsn-roundedbox jsn-duohead" />
                    </div></div>
			<?php
				}
			...
			?>
                    <div id="jsn-pos-promo">
                        <jdoc:include type="modules" name="promo" style="jsnmodule" class="jsn-roundedbox jsn-duohead" />
                    </div>
			<?php
				}
			...
			?>
                    <div id="jsn-pos-promo-right"><div id="jsn-pos-promo-right_inner">
						<jdoc:include type="modules" name="promo-right" style="jsnmodule" class="jsn-roundedbox jsn-duohead" />
                    </div></div>
			<?php
				}
			?>
			...
			?>
				<div id="jsn-pos-content-top" class="jsn-modulescontainer jsn-horizontallayout jsn-modulescontainer<?php echo $this->countModules('content-top'); ?> clearafter">
		...
		?>
								<div id="jsn-pos-user-top" class="jsn-modulescontainer jsn-horizontallayout jsn-modulescontainer<?php echo $this->countModules('user-top'); ?> clearafter">
		...
		?>
									<div id="jsn-pos-mainbody-top" class="jsn-modulescontainer jsn-horizontallayout jsn-modulescontainer<?php echo $this->countModules('mainbody-top'); ?> clearafter">
		...
		?>
									<div id="jsn-pos-mainbody-bottom" class="jsn-modulescontainer jsn-horizontallayout jsn-modulescontainer<?php echo $this->countModules('mainbody-bottom'); ?> clearafter">
		...
		<?php
			...
			if ($this->countModules('user-bottom') > 0) { ?>
								<div id="jsn-pos-user-bottom" class="jsn-modulescontainer jsn-horizontallayout jsn-modulescontainer<?php echo $this->countModules('user-bottom'); ?> clearafter">
		...
		<?php
			/*====== Show elements in left side column ======*/
			if ($jsnutils->countPositions($this, array('left-top', 'left-2', 'left', 'left-bottom'))) {
		?>
					<div id="jsn-leftsidecontent">
						<div id="jsn-leftsidecontent_inner">
			<?php
				/*====== Show modules in position "left-top" ======*/
				if ($this->countModules('left-top') > 0) {
			?>
	                        <div id="jsn-pos-left-top">
	                        	<jdoc:include type="modules" name="left-top" style="jsnmodule" class="jsn-roundedbox jsn-duohead" />
	                        </div>
	        <?php
				}

				/*====== Show modules in position "left" and "left-2" ======*/
			...
			?>
				...
				<?php
					/*====== Show modules in position "left-2" ======*/
					if ($this->countModules('left-2') > 0) {
				?>
	                            <div id="jsn-pos-left-2">
	                            	<jdoc:include type="modules" name="left-2" style="jsnmodule" class="jsn-roundedbox jsn-duohead" />
	                            </div>
	            <?php
					}
			...
			<?php
				...
				/*====== Show modules in position "left-bottom" ======*/
				if ($this->countModules('left-bottom') > 0) {
			?>
	                        <div id="jsn-pos-left-bottom">
	                        	<jdoc:include type="modules" name="left-bottom" style="jsnmodule" class="jsn-roundedbox jsn-duohead" />
	                        </div>
	        <?php
				}
			?>
		...
		<?php
			...
			/*====== Show elements in right side column ======*/
			if ($jsnutils->countPositions($this, array('right-top', 'right', 'right-2', 'right-bottom'))) {
		?>
					<div id="jsn-rightsidecontent">
						<div id="jsn-rightsidecontent_inner">
			<?php
				/*====== Show modules in position "right-top" ======*/
				if ($this->countModules('right-top') > 0) {
			?>
	                        <div id="jsn-pos-right-top">
	                          	<jdoc:include type="modules" name="right-top" style="jsnmodule" class="jsn-roundedbox jsn-duohead" />
	                        </div>
	        <?php
				}

				/*====== Show modules in position "right" and "right-2" ======*/
			...
			?>
				...
				<?php
					...
					/*====== Show modules in position "right-2" ======*/
					if ($this->countModules('right-2') > 0) {
				?>
	                            <div id="jsn-pos-right-2">
	                            	<jdoc:include type="modules" name="right-2" style="jsnmodule" class="jsn-roundedbox jsn-duohead" />
	                            </div>
				<?php
					}
				?>
			...
			<?php
				...
				/*====== Show modules in position "right-bottom" ======*/
				if ($this->countModules('right-bottom') > 0) {
			?>
	                        <div id="jsn-pos-right-bottom">
	                        	<jdoc:include type="modules" name="right-bottom" style="jsnmodule" class="jsn-roundedbox jsn-duohead" />
	                        </div>
	        <?php
				}
			?>
	...
	<?php
		/*====== Show brand. Please do not remove following code or we can not support you with this product ! ======*/
		if ($show_brand) {
	?>
		<div id="jsn-brand">
