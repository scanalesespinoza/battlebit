 ...
 */
	...
	$is_ie6				= (@$brower_info['browser'] == 'msie' && (int) @$brower_info['version'] == 6);
	$is_ie7				= (@$brower_info['browser'] == 'msie' && (int) @$brower_info['version'] == 7);
	$ieoffset 			= ($is_ie6 || $is_ie7)?0.1:0;
	...
	// Define to show brand text or not
	$show_brand = ($template_details->edition == "UNLIMITED")?false:true;
